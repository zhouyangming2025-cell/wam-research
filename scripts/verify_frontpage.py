...
# --- Phase-A Census Round 1 text-layer batch (CORPUS_BATCH=census1) ---
    "P0035": ("GAIA1", "GAIA-1: A Generative World Model for Autonomous Driving",
              "Hu", ["Russell", "Yeo", "Murez", "Fedoseev", "Kendall", "Shotton", "Corrado"]),
    "P0036": ("DriveDreamer", "DriveDreamer: Towards Real-world-driven World Models for Autonomous Driving",
              "Wang", ["Zhu", "Huang", "Chen", "Zhu", "Lu"]),
    "P0037": ("DriveWM", "Driving into the Future: Multiview Visual Forecasting and Planning with World Model for Autonomous Driving",
              "Wang", ["He", "Fan", "Li", "Chen", "Zhang"]),
    "P0038": ("Vista", "Vista: A Generalizable Driving World Model with High Fidelity and Versatile Controllability",
              "Gao", ["Yang", "Chen", "Chitta", "Qiu", "Geiger", "Zhang", "Li"]),
    "P0039": ("DriveDreamer2", "DriveDreamer-2: LLM-Enhanced World Models for Diverse Driving Video Generation",
              "Zhao", ["Wang", "Zhu", "Chen", "Huang", "Bao", "Wang"]),
    "P0040": ("DrivingGPT", "DrivingGPT: Unifying Driving World Modeling and Planning with Multi-modal Autoregressive Transformers",
              "Chen", ["Wang", "Zhang"]),
    "P0041": ("PolicyWM", "From Forecasting to Planning: Policy World Model for Collaborative State-Action Prediction",
              "Zhao", ["Fu", "Wang", "Wang", "Lu"]),
    "P0042": ("WorldDrive", "Bridging Scene Generation and Planning: Driving with World Model via Unifying Vision and Motion Representation",
              "Gui", ["Zhang", "Yan", "Han", "Gong", "Tan", "Xu", "Shen"]),
    "P0043": ("OccWorld", "OccWorld: Learning a 3D Occupancy World Model for Autonomous Driving",
              "Zheng", ["Chen", "Huang", "Zhang", "Duan", "Lu"]),
    "P0044": ("DriveOccWorld", "Driving in the Occupancy World: Vision-Centric 4D Occupancy Forecasting and Planning via World Models for Autonomous Driving",
              "Yang", ["Mei", "Ma", "Du", "Chen", "Qian", "Feng", "Liu"]),
    "P0045": ("WoTE", "End-to-End Driving with Online Trajectory Evaluation via BEV World Model",
              "Li", ["Wang", "Liu", "He", "Fan", "Zhang"]),
    "P0046": ("World4Drive", "World4Drive: End-to-End Autonomous Driving via Intention-aware Physical Latent World Model",
              "Zheng", ["Yang", "Xing", "Zhang", "Zheng", "Gao", "Li", "Zhang", "Xia", "Jia", "Lang", "Zhao"]),
    "P0047": ("DriveWorld", "DriveWorld: 4D Pre-trained Scene Understanding via World Models for Autonomous Driving",
              "Min", ["Zhao", "Xiao", "Zhao", "Xu", "Zhu", "Jin", "Li", "Guo", "Xing", "Jing", "Nie"]),
    "P0048": ("LAW", "Enhancing End-to-End Autonomous Driving with Latent World Model",
              "Li", ["Fan", "He", "Wang", "Chen", "Zhang", "Tan"]),
    "P0049": ("DriveJEPA", "Drive-JEPA: Video JEPA Meets Multimodal Trajectory Distillation for End-to-End Driving",
              "Wang", ["Yang", "Bai", "Zhang", "Liu", "Zheng", "Long", "Lu", "Lu"]),
    "P0050": ("WorldRFT", "WorldRFT: Latent World Model Planning with Reinforcement Fine-Tuning for Autonomous Driving",
              "Yang", ["Lu", "Xia", "Han", "Gao", "Zhang", "Zhan", "Lang", "Zheng", "Zhang"]),
    "P0051": ("AutoJEPA", "Auto-JEPA: A Latent World Model of Continuous Intent for End-to-End Autonomous Driving",
              "Yang", ["Chen", "Huang", "Li"]),
    "P0052": ("ReWorld", "ReWorld: Representation Learning for World Action Models",
              "Xia", ["Zhou", "Xiong", "Yao", "Zhu", "Sun", "Wang", "Chen", "Liu", "Ye", "Wang"]),
    "P0053": ("WAJEPA", "WA-JEPA: Rethinking the Video JEPA Paradigm for World-Action Modeling in Autonomous Driving",
              "Wang", ["Xiang", "Zhou", "Wang", "Huang", "Huang", "Wei", "Zhou", "Wang", "Chen", "Xu", "Tan"]),
    "P0054": ("WhatTrulyMatters", "What Truly Matters in Trajectory Prediction for Autonomous Driving?",
              "Phong", ["Wu", "Yu", "Cai", "Zheng", "Hsu"]),
    "P0055": ("SLEDGE", "SLEDGE: Synthesizing Driving Environments with Generative Models and Rule-Based Traffic",
              "Chitta", ["Dauner", "Geiger"]),
    "P0056": ("DriveArena", "DriveArena: A Closed-loop Generative Simulation Platform for Autonomous Driving",
              "Yang", ["Wen", "Ma", "Mei", "Li", "Wei", "Lei", "Fu", "Cai", "Dou", "Shi", "He"]),
    "P0057": ("UniAD", "Planning-Oriented Autonomous Driving",
              "Hu", ["Yang", "Chen", "Li", "Sima", "Zhu", "Chai", "Du", "Lin", "Wang", "Lu", "Jia"]),
    "P0058": ("VAD", "VAD: Vectorized Scene Representation for Efficient Autonomous Driving",
              "Jiang", ["Chen", "Xu", "Liao", "Chen", "Zhou", "Zhang", "Liu", "Huang", "Wang"]),
    "P0059": ("DiffusionDrive", "DiffusionDrive: Truncated Diffusion Model for End-to-End Autonomous Driving",
