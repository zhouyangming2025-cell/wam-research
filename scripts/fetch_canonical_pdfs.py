...
# Sources proposed by scripts/plan_census_acquisition.py and verified in this batch.
    dict(paper_id="P0035", short="GAIA1",
         url="https://arxiv.org/pdf/2309.17080",
         source_version="arXiv_v1",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2309.17080"),
    dict(paper_id="P0036", short="DriveDreamer",
         url="https://arxiv.org/pdf/2309.09777",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2309.09777"),
    dict(paper_id="P0037", short="DriveWM",
         ...
         basis="resolved in this batch by discovery then verification: the document was located through https://openaccess.thecvf.com/CVPR2024?day=all, and the official record was verified independently (title 'Driving into the Future: Multiview Visual Forecasting and Planning wit', CVF Open Access). Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/CVPR2024/html/Wang_Driving_into_the_Future_Multiview_Visual_Forecasting_and_Planning_with_CVPR_2024_paper.html"),
    dict(paper_id="P0038", short="Vista",
         url="https://arxiv.org/pdf/2405.17398",
         source_version="arXiv_v5",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2405.17398"),
    dict(paper_id="P0039", short="DriveDreamer2",
         url="https://arxiv.org/pdf/2403.06845",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2403.06845"),
    dict(paper_id="P0040", short="DrivingGPT",
         url="https://openaccess.thecvf.com/content/ICCV2025/papers/Chen_DrivingGPT_Unifying_Driving_World_Modeling_and_Planning_with_Multi-modal_Autoregressive_ICCV_2025_paper.pdf",
         source_version="ICCV2025_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/ICCV2025/html/Chen_DrivingGPT_Unifying_Driving_World_Modeling_and_Planning_with_Multi-modal_Autoregressive_ICCV_2025_paper.html"),
    dict(paper_id="P0041", short="PolicyWM",
         url="https://arxiv.org/pdf/2510.19654",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2510.19654"),
    dict(paper_id="P0042", short="WorldDrive",
         url="https://arxiv.org/pdf/2603.14948",
         source_version="arXiv_v1",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2603.14948"),
    dict(paper_id="P0043", short="OccWorld",
         url="https://arxiv.org/pdf/2311.16038",
         source_version="arXiv_v1",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2311.16038"),
    dict(paper_id="P0044", short="DriveOccWorld",
         url="https://arxiv.org/pdf/2408.14197",
         source_version="arXiv_v3",
         basis="resolved in this batch by discovery then verification: the document was located through https://drive-occworld.github.io/, and the official record was verified independently (title 'Driving in the Occupancy World: Vision-Centric 4D Occupancy Forecastin', arXiv:2408.14197v3). Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2408.14197"),
    dict(paper_id="P0045", short="WoTE",
         url="https://openaccess.thecvf.com/content/ICCV2025/papers/Li_End-to-End_Driving_with_Online_Trajectory_Evaluation_via_BEV_World_Model_ICCV_2025_paper.pdf",
         source_version="ICCV2025_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/ICCV2025/html/Li_End-to-End_Driving_with_Online_Trajectory_Evaluation_via_BEV_World_Model_ICCV_2025_paper.html"),
    dict(paper_id="P0046", short="World4Drive",
         url="https://openaccess.thecvf.com/content/ICCV2025/papers/Zheng_World4Drive_End-to-End_Autonomous_Driving_via_Intention-aware_Physical_Latent_World_Model_ICCV_2025_paper.pdf",
         source_version="ICCV2025_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/ICCV2025/html/Zheng_World4Drive_End-to-End_Autonomous_Driving_via_Intention-aware_Physical_Latent_World_Model_ICCV_2025_paper.html"),
    dict(paper_id="P0047", short="DriveWorld",
         url="https://openaccess.thecvf.com/content/CVPR2024/papers/Min_DriveWorld_4D_Pre-trained_Scene_Understanding_via_World_Models_for_Autonomous_CVPR_2024_paper.pdf",
         source_version="CVPR2024_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/CVPR2024/html/Min_DriveWorld_4D_Pre-trained_Scene_Understanding_via_World_Models_for_Autonomous_CVPR_2024_paper.html"),
    dict(paper_id="P0048", short="LAW",
         url="https://arxiv.org/pdf/2406.08481",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2406.08481"),
    dict(paper_id="P0049", short="DriveJEPA",
         url="https://arxiv.org/pdf/2601.22032",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2601.22032"),
    dict(paper_id="P0050", short="WorldRFT",
         url="https://arxiv.org/pdf/2512.19133",
         source_version="arXiv_v1",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2512.19133"),
    dict(paper_id="P0051", short="AutoJEPA",
         url="https://arxiv.org/pdf/2607.29031",
         source_version="arXiv_v1",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2607.29031"),
    dict(paper_id="P0052", short="ReWorld",
         url="https://arxiv.org/pdf/2606.27504",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2606.27504"),
    dict(paper_id="P0053", short="WAJEPA",
         url="https://arxiv.org/pdf/2608.20974",
         source_version="arXiv_v2",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2608.20974"),
    dict(paper_id="P0054", short="WhatTrulyMatters",
         url="https://papers.neurips.cc/paper_files/paper/2023/file/e197fe307eb3467035f892dc100d570a-Paper-Conference.pdf",
         source_version="NeurIPS2023_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://papers.neurips.cc/paper_files/paper/2023/hash/e197fe307eb3467035f892dc100d570a-Abstract-Conference.html"),
    dict(paper_id="P0055", short="SLEDGE",
         url="https://arxiv.org/pdf/2403.17933",
         source_version="arXiv_v2",
         basis="resolved in this batch by discovery then verification: the arXiv link was found on the paper's own project repository page, then the official arXiv record was fetched and verified independently (citation_title 'SLEDGE: Synthesizing Driving Environments with Generative Models and R', 2024/03/26, v2). Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2403.17933"),
    dict(paper_id="P0056", short="DriveArena",
         url="https://arxiv.org/pdf/2408.00415",
         source_version="arXiv_v1",
         basis="resolved in this batch by discovery then verification: the document was located through https://github.com/PJLab-ADG/DriveArena, and the official record was verified independently (title 'DriveArena: A Closed-loop Generative Simulation Platform for Autonomou', arXiv:2408.00415v1). Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://arxiv.org/abs/2408.00415"),
    dict(paper_id="P0057", short="UniAD",
         url="https://openaccess.thecvf.com/content/CVPR2023/papers/Hu_Planning-Oriented_Autonomous_Driving_CVPR_2023_paper.pdf",
         source_version="CVPR2023_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/CVPR2023/html/Hu_Planning-Oriented_Autonomous_Driving_CVPR_2023_paper.html"),
    dict(paper_id="P0058", short="VAD",
         url="https://openaccess.thecvf.com/content/ICCV2023/papers/Jiang_VAD_Vectorized_Scene_Representation_for_Efficient_Autonomous_Driving_ICCV_2023_paper.pdf",
         source_version="ICCV2023_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/ICCV2023/html/Jiang_VAD_Vectorized_Scene_Representation_for_Efficient_Autonomous_Driving_ICCV_2023_paper.html"),
    dict(paper_id="P0059", short="DiffusionDrive",
         url="https://openaccess.thecvf.com/content/CVPR2025/papers/Liao_DiffusionDrive_Truncated_Diffusion_Model_for_End-to-End_Autonomous_Driving_CVPR_2025_paper.pdf",
         source_version="CVPR2025_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/CVPR2025/html/Liao_DiffusionDrive_Truncated_Diffusion_Model_for_End-to-End_Autonomous_Driving_CVPR_2025_paper.html"),
    dict(paper_id="P0060", short="DrivoR",
         url="https://openaccess.thecvf.com/content/CVPR2026/papers/Kirby_Driving_on_Registers_CVPR_2026_paper.pdf",
         source_version="CVPR2026_camera_ready",
         basis="selected by the acquisition planner. Official landing page verified in this batch: citation_title matches the census entry",
         alternate_official="https://openaccess.thecvf.com/content/CVPR2026/html/Kirby_Driving_on_Registers_CVPR_2026_paper.html"),

    # --- Phase C.5 Core-WAM batch ---
    dict(paper_id="P0061", short="SeerDrive",
         url="https://arxiv.org/pdf/2510.11092",
         source_version="arXiv_v1",
         basis="Phase C.5 target; official arXiv record verified against title and first author",
         alternate_official="https://arxiv.org/abs/2510.11092"),
    dict(paper_id="P0062", short="Metis",
         url="https://arxiv.org/pdf/2606.15869",
         source_version="arXiv_v1",
         basis="Phase C.5 target; official arXiv record verified against title and first author",
         alternate_official="https://arxiv.org/abs/2606.15869"),
    dict(paper_id="P0063", short="DynFlowDrive",
         url="https://arxiv.org/pdf/2603.19675",
         source_version="arXiv_v2",
         basis="Phase C.5 target; official arXiv record verified against title and first author; latest arXiv version is v2",
         alternate_official="https://arxiv.org/abs/2603.19675"),
    dict(paper_id="P0064", short="Discrete-WAM",
         url="https://arxiv.org/pdf/2606.05645",
         source_version="arXiv_v2",
         basis="Phase C.5 target; official arXiv record verified against title and first author; latest arXiv version is v2",
         alternate_official="https://arxiv.org/abs/2606.05645"),
    dict(paper_id="P0065", short="GraphWorld",
         url="https://arxiv.org/pdf/2606.16274",
         source_version="arXiv_v1",
         basis="Phase C.5 target; official arXiv record verified against title and first author",
         alternate_official="https://arxiv.org/abs/2606.16274"),
