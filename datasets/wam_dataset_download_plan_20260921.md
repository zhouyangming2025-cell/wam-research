...
> **前置审计更新（2026-09-21）**：本计划已完成现场与官方源的第一轮下载前置深审；当前阻塞、对象 manifest gate、210 字节通道探针结果和建议执行顺序见 `../audits/datasets/download_preflight_audit_20260921.md`。在该审计的 Gate A 未通过前，不得建 queue 或启动下载。
